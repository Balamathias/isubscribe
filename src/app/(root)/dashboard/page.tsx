  ...
  return (
    <WidthWrapper className='flex flex-col space-y-2.5 sm:space-y-4 !max-w-3xl md:py-12 mt-16 max-sm:mt-8'>
      ...
      <div className='flex flex-col space-y-1 md:hidden'>
        <h2 className='text-muted-foreground text-lg'>{getGreeting(profile?.full_name?.split(' ')?.at(0) ?? '')}</h2>
        <p className='text-muted-foreground text-xs'>What would you love to subscribe today?</p>
      </div>
