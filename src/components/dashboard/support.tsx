import { LucideHeadphones, LucideMail, LucidePhone } from 'lucide-react'
    ...
    <div className="flex flex-col gap-y-3 p-4">
        ...
        <div className="flex flex-col space-y-4">
            ...
            <div className='flex flex-row items-center gap-x-2'>
                ...
                <Link className="bg-purple-600/5 text-purple-600 py-1 px-3 rounded-full text-sm md:text-base" href={'mailto:isubscribenetwork@gmail.com'}>
