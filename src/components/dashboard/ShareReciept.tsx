  ...
  return (
    <>
       <Card className='shadow-none bg-secondary/15 dark:bg-secondary/50 border-none rounded-xl  flex flex-row gap-4 p-2 items-center justify-between w-full '>
        ...
        <Link href={sLink} className=' hover:opacity-70 hover:transition-all ring-1 shadow-none border-none rounded-xl  flex flex-row gap-4 max-md:gap-2 items-center justify-center p-4 max-sm:p-2 w-full '>
