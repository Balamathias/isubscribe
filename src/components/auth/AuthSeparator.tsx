  ...
  return (
    <div className={cn("relative my-4", seperatorWrapperClassName)}>
        <div className="absolute inset-0 flex items-center">
            <div className={cn("w-full border-t border-gray-300", leftSeparatorClassName)}></div>
        </div>
        <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">{separatorText ? separatorText : 'Or with Email and Password'}</span>
        </div>
    </div>
  )
}
