...
const AboutUs = () => {
  return (
    <>
     <DynamicSheet 
       trigger={ <button className=' absolute rounded-full flex p-2 py-1 items-center top-2 right-8 justify-center bg-violet-100 border-[3px] border-dashed'>About us</button>}
